...
rawFuncs =
  ...
  , "quotRem :: Integral a => a -> a -> Pair a a"
  , "divMod :: Integral a => a -> a -> Pair a a"
  ...
  , "floatRange :: RealFloat a => a -> Pair Int Int"
  , "decodeFloat :: RealFloat a => a -> Pair Integer Int"
  ...
  , "properFraction :: RealFrac a => Integral b => a -> Pair b a"
  ...
  , "unzip :: List (a, b) -> Pair (List a) (List b)"
  , "unzip3 :: List (a, b, c) -> Triple (List a) (List b) (List c)"
